...
unsigned long NPersonagens;
InstanciaBZ Personagens[15];
...
{
    if (Personagens[0].tAtual>1.0)
        Personagens[0].tAtual = 0.0;
    else{
        float DeltaT = 1.0/50.0;
        Personagens[0].tAtual += DeltaT;
    }
    Ponto P = CalculaBezier3(Curva1, Personagens[0].tAtual);
